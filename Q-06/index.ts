/*  Stripping Names: Store a person’s name, and include some whitespace characters 
    ...
    console.log(whitespaceName);        //print the name with white space & new line


    console.log(whitespaceName.trim());        //print the name without white space & new line using trim function