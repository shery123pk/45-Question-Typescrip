/*  Famous Quote 2: Repeat Exercise 4, but this time store the famous person’s name 
    ...
    let famous_person = 'Albert Einstein';          //store famous person name

    //message store in a variable
    let message = 'said, a person who never made a mistake never tried any thing new';

    //print famous person name with message
